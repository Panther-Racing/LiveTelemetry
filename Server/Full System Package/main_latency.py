...
import CAN_Translate_And_Send_v3_latency_testing
import send_sql_v1
import Server_v4
...
def translate_process():
    ...
    translate = Process(target=CAN_Translate_And_Send_v3_latency_testing.start(server_conn, translate_child_conn))
    translate.start()
