...
class Signal:
    ...
    def __repr__(self) -> str:
        ...
        return (
            ...
            f"raw_initial:{self.raw_initial}, "
            f"conversion.scale:{self.conversion.scale}, "
            f"conversion.offset:{self.conversion.offset}, "
            f"minimum:{self.minimum}, "
            f"maximum:{self.maximum}, "
            f"unit:'{self.unit}', "
            f"is_multiplexer:{self.is_multiplexer}, "
            f"multiplexer_ids:{self.multiplexer_ids}, "
            f"choices:{choices}, "
            f"spn:{self.spn}, "
